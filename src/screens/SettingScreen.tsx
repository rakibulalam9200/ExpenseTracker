...
import { Settings, X, PieChart, BarChart3, ArrowLeft, Bolt } from 'lucide-react-native';
...
[Settings, X, PieChart, BarChart3, ArrowLeft].forEach((icon) => {
    cssInterop(icon, {
        className: {
            target: 'style',
            nativeStyleToProp: {
    ...
    return (
        <SafeAreaView className="flex-1 bg-slate-50 dark:bg-slate-950">
            <View className="flex-row items-center px-4 py-4 z-10 border-b border-slate-200 dark:border-slate-800">
                ...
                <Text className="text-xl font-bold text-slate-900 dark:text-white" style={{ fontFamily }}>
                    {t('settings') || 'Settings'}
                </Text>
            </View>
            ...
            <View className="flex-1 px-4 pt-6">
                ...
                >
                    ...
                    <Text className="text-base text-primary-700 dark:text-slate-200 font-bold flex-1" style={{ fontFamily }}>
                        {t('expenseChart')}
                    </Text>
                </TouchableOpacity>
                ...
                >
                    ...
                    <Text className="text-base text-slate-800 dark:text-slate-200 font-bold flex-1" style={{ fontFamily }}>
                        {t('yearlyReport')}
                    </Text>
                </TouchableOpacity>
                <ManageTypes
