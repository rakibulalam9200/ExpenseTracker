...
export const translations = {
  en: {
    ...
    givingLoan: 'Giving Loan (Creditor)',
    takingLoan: 'Taking Loan (Debtor)',
  ...
  bn: {
    ...
    selectMonthYear: 'মাস ও বছর',
    budgetExceeded: 'বাজেট অতিক্রম করেছে',
    budgetLeft: 'অবশিষ্ট',
    loanManagement: 'ঋণ ব্যবস্থাপনা',
    givingLoan: 'ঋণ দেওয়া (পাওনাদার)',
    takingLoan: 'ঋণ নেওয়া (দেনা)',
    totalGiven: 'মোট দেওয়া',
    totalTaken: 'মোট নেওয়া',
    debtorCreditor: 'দেনা / পাওনাদার',
    dueDate: 'নির্ধারিত তারিখ',
    payableDate: 'পরিশোধের তারিখ',
    status: 'অবস্থা',
    rating: 'রেটিং',
    transactionWay: 'লেনদেনের উপায়',
    cash: 'নগদ',
    bank: 'ব্যাংক',
